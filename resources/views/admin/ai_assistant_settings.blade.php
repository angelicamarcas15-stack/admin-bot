...
<div class="bg-[#0B1221] text-gray-300 flex overflow-hidden h-[calc(100vh-64px)]">
        ...
        <div class="flex-1 overflow-auto p-6 space-y-6">
            ...
            <div class="bg-[#0D1324] rounded-xl border border-white/5 p-5">
                ...
                @if(!empty($config->instructions))
                    <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5 mt-3">
            ...
            <div class="bg-[#0D1324] rounded-xl border border-white/5 p-5">
                ...
                <form
                    id="uploadForm"
                    action="{{ route('admin.knowledge.upload') }}"
                    method="POST"
                    ...
                    @foreach($files as $file)
                        <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5 flex items-center justify-between hover:border-blue-500/50 transition-colors">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <form
                                    method="POST"
                                    action="{{ route('admin.knowledge.delete', $file->id) }}"
                                >
                                    @csrf
                                    @method('DELETE')
                        ...
                        <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                />
                                 ...
                                 <form
                                    method="POST"
                                    action="{{ route('admin.webref.delete', $ref->id) }}"
                                >
                                    @csrf
                                    @method('DELETE')
                                    <button class="p-2 hover:bg-red-500/20 rounded-lg transition-colors">
    ...
    <div id="modalAddWebReference" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
        <div class="bg-[#0D1324] rounded-2xl border border-white/10 w-full max-w-md">
            ...
            <!-- Header -->
            <div class="p-6 border-b border-white/10">
                <h2 id="modalAddWebReferenceTitle" class="text-xl font-semibold text-white">Agregar URL de Referencia</h2>
            </div>
