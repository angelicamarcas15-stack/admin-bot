        ...
        <section class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-auto p-6 space-y-6">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button id="editPromptBtn" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button class="px-4 py-2 bg-white/5 text-gray-300 rounded-lg hover:bg-white/10 transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="space-y-3">
                    <!-- File 1 -->
                    <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5 flex items-center justify-between hover:border-blue-500/50 transition-colors">
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button id="addRefBtn" class="px-4 py-2 bg-white/5 text-gray-300 rounded-lg hover:bg-white/10 transition-colors flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M12 4v16m8-8H4" />
                    </svg>
                    Agregar URL
                ...
                <p class="text-sm text-gray-400 mb-4">URLs de referencia que el asistente puede consultar para obtener información actualizada</p>

                <div class="space-y-3">
                    <!-- Reference 1 -->
                    <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5">
                    <label class="block text-xs text-gray-400 mb-2">SUNAT - Superintendencia Nacional de Aduanas y de Administración Tributaria</label>
                    <div class="flex items-center gap-2">
                        <input type="text" value="https://www.sunat.gob.pe" readonly class="flex-1 bg-[#0D1324] px-4 py-2 rounded-lg text-white border border-white/5 focus:border-blue-500 outline-none text-sm" />
                        <button class="p-2 hover:bg-red-500/20 rounded-lg transition-colors">
                        <svg class="w-4 h-4 text-red-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                        </svg>
                    ...
                    <!-- Reference 2 -->
                    <div class="bg-[#1A2236] rounded-lg p-4 border border-white/5">
                    <label class="block text-xs text-gray-400 mb-2">SUNARP - Superintendencia Nacional de los Registros Públicos</label>
                    <div class="flex items-center gap-2">
                        <input type="text" value="https://www.sunarp.gob.pe" readonly class="flex-1 bg-[#0D1324] px-4 py-2 rounded-lg text-white border border-white/5 focus:border-blue-500 outline-none text-sm" />
                        <button class="p-2 hover:bg-red-500/20 rounded-lg transition-colors">
                        <svg class="w-4 h-4 text-red-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                        </svg>
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" value="https://www.gob.pe" readonly class="flex-1 bg-[#0D1324] px-4 py-2 rounded-lg text-white border border-white/5 focus:border-blue-500 outline-none text-sm" />
                        <button class="p-2 hover:bg-red-500/20 rounded-lg transition-colors">
                        <svg class="w-4 h-4 text-red-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                        </svg>
        ...
        <div id="editModal" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
            <div class="bg-[#0D1324] rounded-2xl border border-white/10 w-full max-w-3xl">
                ...
                <div class="p-6">
                    ...
                    <textarea id="promptTextarea" rows="12" class="w-full bg-[#1A2236] px-4 py-3 rounded-xl text-white placeholder-gray-500 border border-white/5 focus:border-blue-500 outline-none resize-none" placeholder="Escribe las instrucciones para el asistente...">Eres un asistente especializado en el programa PNTE (Programa Nacional de Transformación Empresarial) del gobierno peruano. Tu objetivo es ayudar a asesores y empresarios con información precisa sobre normativas, procedimientos y mejores prácticas del programa. Debes ser claro, profesional y siempre citar las fuentes oficiales cuando proporciones información regulatoria.</textarea>
                </div>

                <div class="p-6 border-t border-white/10 flex gap-3 justify-end">
                    <button id="cancelModalBtn" class="px-5 py-2.5 bg-white/5 text-gray-300 rounded-xl hover:bg-white/10 transition-colors">
                    Cancelar
                    </button>
                    <button id="saveModalBtn" class="px-5 py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors">
                    Guardar Cambios
                    </button>
                </div>
            </div>
