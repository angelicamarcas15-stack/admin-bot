...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/advisories.css') }}?v={{ time() }}">
@endpush
...
@section('body')
    ...
    <div class="bg-[#0B1221] text-gray-300 flex overflow-hidden h-[calc(100vh-64px)]">
        ...
        <section class="flex-1 flex flex-col overflow-hidden">
            ...
            <!-- Table -->
            <div id="advisor" class="flex-1 overflow-auto p-6">
                                ...
                                <tr class="border-b border-white/5">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-center gap-2">
                                            <button onclick='editAsesor(@json($advisor))'
                                                class="p-2 hover:bg-blue-500/20 rounded-lg transition-colors">
                                            ...
                                            <button type="button" onclick='deleteAsesor(@json($advisor))'
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <input id="nombreInput" type="text"
                            class="w-full bg-[#1A2236] px-4 py-2.5 rounded-xl text-white placeholder-gray-500 border border-white/5 focus:border-blue-500 outline-none"
                            placeholder="Ej: Juan Pérez" />
                    </div>

                    <div>
                        <label class="block text-sm text-gray-400 mb-2">Número de Contacto</label>
                        <input id="contactoInput" type="tel"
                            class="w-full bg-[#1A2236] px-4 py-2.5 rounded-xl text-white placeholder-gray-500 border border-white/5 focus:border-blue-500 outline-none"
                    ...
                    <div>
                        ...
                        <select id="regionSelect" onchange="onChangeUbigeo(this.value, 'province')"
                    ...
                    <div>
                        ...
                        <select id="provinciaSelect" onchange="onChangeUbigeo(this.value, 'district')"
                            class="w-full bg-[#1A2236] px-4 py-2.5 rounded-xl text-white border border-white/5 focus:border-blue-500 outline-none">
